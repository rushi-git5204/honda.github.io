...
;function Ma(a){if(Error.captureStackTrace)Error.captureStackTrace(this,Ma);else{var b=Error().stack;b&&(this.stack=b)}a&&(this.message=String(a))}
y(Ma,Error);Ma.prototype.name="CustomError";var Na;var Oa=Array.prototype.indexOf?function(a,b){return Array.prototype.indexOf.call(a,b,void 0)}:function(a,b){if("string"===typeof a)return"string"!==typeof b||1!=b.length?-1:a.indexOf(b,0);
...
;var fb;a:{var gb=n.navigator;if(gb){var hb=gb.userAgent;if(hb){fb=hb;break a}}fb=""}function A(a){return-1!=fb.indexOf(a)}
...
function ob(a){var b=Aa(a);if("object"==b||"array"==b){if(Da(a.clone))return a.clone();b="array"==b?[]:{};for(var c in a)b[c]=ob(a[c]);return b}return a}
...
;function rb(){return A("Firefox")||A("FxiOS")}
function sb(){return A("Safari")&&!(tb()||A("Coast")||A("Opera")||A("Edge")||A("Edg/")||A("OPR")||rb()||A("Silk")||A("Android"))}
function tb(){return(A("Chrome")||A("CriOS"))&&!A("Edge")}
function ub(){return A("Android")&&!(tb()||rb()||A("Opera")||A("Silk"))}
...
Jb("<!DOCTYPE html>");var Kb=Jb("");Jb("<br>");var Lb=bb(function(){var a=document.createElement("div"),b=document.createElement("div");b.appendChild(document.createElement("div"));a.appendChild(b);b=a.firstChild.firstChild;a.innerHTML=Ib(Kb);return!b.parentElement});
...
;var Vb=A("Opera"),B=A("Trident")||A("MSIE"),Wb=A("Edge"),Xb=Wb||B,Yb=A("Gecko")&&!(-1!=fb.toLowerCase().indexOf("webkit")&&!A("Edge"))&&!(A("Trident")||A("MSIE"))&&!A("Edge"),Zb=-1!=fb.toLowerCase().indexOf("webkit")&&!A("Edge"),$b=A("Macintosh"),ac=A("Windows"),bc=A("Android"),cc=Qb(),dc=A("iPad"),ec=A("iPod"),fc=Rb();function gc(){var a=n.document;return a?a.documentMode:void 0}
var hc;a:{var ic="",kc=function(){var a=fb;if(Yb)return/rv:([^\);]+)(\)|;)/.exec(a);if(Wb)return/Edge\/([\d\.]+)/.exec(a);if(B)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(Zb)return/WebKit\/(\S+)/.exec(a);if(Vb)return/(?:Version)[ \/]?(\S+)/.exec(a)}();
kc&&(ic=kc?kc[1]:"");if(B){var lc=gc();if(null!=lc&&lc>parseFloat(ic)){hc=String(lc);break a}}hc=ic}var mc=hc,Ub={};function nc(a){return Tb(a,function(){return 0<=db(mc,a)})}
var oc;oc=n.document&&B?gc():void 0;var pc=rb(),qc=Qb()||A("iPod"),rc=A("iPad"),sc=ub(),tc=tb(),uc=sb()&&!Rb();var vc={},wc=null;var C=window;function xc(a){this.f=a||{cookie:""}}
...
"")};
m.get=function(a,b){for(var c=a+"=",d=(this.f.cookie||"").split(";"),e=0,f;e<d.length;e++){f=cb(d[e]);if(0==f.lastIndexOf(c,0))return f.substr(c.length);if(f==a)return""}return b};
...
m.clear=function(){for(var a=(this.f.cookie||"").split(";"),b=[],c=[],d,e,f=0;f<a.length;f++)e=cb(a[f]),d=e.indexOf("="),-1==d?(b.push(""),c.push(e)):(b.push(e.substring(0,d)),c.push(e.substring(d+1)));for(a=b.length-1;0<=a;a--)this.remove(b[a])};
...
m.round=function(){this.width=Math.round(this.width);this.height=Math.round(this.height);return this};function Dc(a){return a?new Ec(Fc(a)):Na||(Na=new Ec)}
...
function Ic(a,b){ib(b,function(c,d){c&&"object"==typeof c&&c.T&&(c=c.S());"style"==d?a.style.cssText=c:"class"==d?a.className=c:"for"==d?a.htmlFor=c:Jc.hasOwnProperty(d)?a.setAttribute(Jc[d],c):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,c):a[d]=c})}
...
return a}
var qd={Ab:"allow-forms",Bb:"allow-modals",Cb:"allow-orientation-lock",Db:"allow-pointer-lock",Eb:"allow-popups",Fb:"allow-popups-to-escape-sandbox",Gb:"allow-presentation",Hb:"allow-same-origin",Ib:"allow-scripts",Jb:"allow-top-navigation",Kb:"allow-top-navigation-by-user-activation"},sd=bb(function(){return rd()});
...
Yd.load=function(a,b){return Ie(function(){return Je(a,b)})};function Le(){this.g=[];this.f=-1}
Le.prototype.set=function(a,b){b=void 0===b?!0:b;0<=a&&52>a&&0===a%1&&this.g[a]!=b&&(this.g[a]=b,this.f=-1)};
Le.prototype.get=function(a){return!!this.g[a]};
function Me(a){-1==a.f&&(a.f=Ra(a.g,function(b,c,d){return c?b+Math.pow(2,d):b},0));
return a.f}
;function Ne(a,b){this.i=a;this.l=b;this.g=0;this.f=null}
Ne.prototype.get=function(){if(0<this.g){this.g--;var a=this.f;this.f=a.next;a.next=null}else a=this.i();return a};
function Oe(a,b){a.l(b);100>a.g&&(a.g++,b.next=a.f,a.f=b)}
;function Pe(a){n.setTimeout(function(){throw a;},0)}
var Qe;
function Re(){var a=n.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&!A("Presto")&&(a=function(){var e=Pc(document,"IFRAME");e.style.display="none";Nb(e);document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.write(Ib(Kb));e.close();var h="callImmediate"+Math.random(),g="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=w(function(k){if(("*"==g||k.origin==g)&&k.data==h)this.port1.onmessage()},this);
...
;function Se(){this.g=this.f=null}
var Ue=new Ne(function(){return new Te},function(a){a.reset()});
Se.prototype.add=function(a,b){var c=Ue.get();c.set(a,b);this.g?this.g.next=c:this.f=c;this.g=c};
Se.prototype.remove=function(){var a=null;this.f&&(a=this.f,this.f=this.f.next,this.f||(this.g=null),a.next=null);return a};
function Te(){this.next=this.scope=this.f=null}
Te.prototype.set=function(a,b){this.f=a;this.scope=b;this.next=null};
Te.prototype.reset=function(){this.next=this.scope=this.f=null};function Ve(a,b){We||Xe();Ye||(We(),Ye=!0);Ze.add(a,b)}
var We;function Xe(){if(n.Promise&&n.Promise.resolve){var a=n.Promise.resolve(void 0);We=function(){a.then($e)}}else We=function(){var b=$e;
!Da(n.setImmediate)||n.Window&&n.Window.prototype&&!A("Edge")&&n.Window.prototype.setImmediate==n.setImmediate?(Qe||(Qe=Re()),Qe(b)):n.setImmediate(b)}}
var Ye=!1,Ze=new Se;function $e(){for(var a;a=Ze.remove();){try{a.f.call(a.scope)}catch(b){Pe(b)}Oe(Ue,a)}Ye=!1}
;function af(){this.g=-1}
;function bf(){this.g=64;this.f=[];this.v=[];this.B=[];this.l=[];this.l[0]=128;for(var a=1;a<this.g;++a)this.l[a]=0;this.o=this.i=0;this.reset()}
y(bf,af);bf.prototype.reset=function(){this.f[0]=1732584193;this.f[1]=4023233417;this.f[2]=2562383102;this.f[3]=271733878;this.f[4]=3285377520;this.o=this.i=0};
function cf(a,b,c){c||(c=0);var d=a.B;if("string"===typeof b)for(var e=0;16>e;e++)d[e]=b.charCodeAt(c)<<24|b.charCodeAt(c+1)<<16|b.charCodeAt(c+2)<<8|b.charCodeAt(c+3),c+=4;else for(e=0;16>e;e++)d[e]=b[c]<<24|b[c+1]<<16|b[c+2]<<8|b[c+3],c+=4;for(e=16;80>e;e++){var f=d[e-3]^d[e-8]^d[e-14]^d[e-16];d[e]=(f<<1|f>>>31)&4294967295}b=a.f[0];c=a.f[1];var h=a.f[2],g=a.f[3],k=a.f[4];for(e=0;80>e;e++){if(40>e)if(20>e){f=g^c&(h^g);var l=1518500249}else f=c^h^g,l=1859775393;else 60>e?(f=c&h|g&(c|h),l=2400959708):
...
bf.prototype.update=function(a,b){if(null!=a){void 0===b&&(b=a.length);for(var c=b-this.g,d=0,e=this.v,f=this.i;d<b;){if(0==f)for(;d<=c;)cf(this,a,d),d+=this.g;if("string"===typeof a)for(;d<b;){if(e[f]=a.charCodeAt(d),++f,++d,f==this.g){cf(this,e);f=0;break}}else for(;d<b;)if(e[f]=a[d],++f,++d,f==this.g){cf(this,e);f=0;break}}this.i=f;this.o+=b}};
bf.prototype.digest=function(){var a=[],b=8*this.o;56>this.i?this.update(this.l,56-this.i):this.update(this.l,this.g-(this.i-56));for(var c=this.g-1;56<=c;c--)this.v[c]=b&255,b/=256;cf(this,this.v);for(c=b=0;5>c;c++)for(var d=24;0<=d;d-=8)a[b]=this.f[c]>>d&255,++b;return a};function df(){this.i=this.i;this.l=this.l}
df.prototype.i=!1;df.prototype.X=function(){return this.i};
df.prototype.dispose=function(){this.i||(this.i=!0,this.ba())};
df.prototype.ba=function(){if(this.l)for(;this.l.length;)this.l.shift()()};
function ef(a){a&&"function"==typeof a.dispose&&a.dispose()}
;function ff(a){return"string"==typeof a.className?a.className:a.getAttribute&&a.getAttribute("class")||""}
function gf(a){return a.classList?a.classList:ff(a).match(/\S+/g)||[]}
function hf(a,b){"string"==typeof a.className?a.className=b:a.setAttribute&&a.setAttribute("class",b)}
function K(a,b){return a.classList?a.classList.contains(b):Ua(gf(a),b)}
function L(a,b){if(a.classList)a.classList.add(b);else if(!K(a,b)){var c=ff(a);hf(a,c+(0<c.length?" "+b:b))}}
function jf(a,b){if(a.classList)z(b,function(f){L(a,f)});
else{var c={};z(gf(a),function(f){c[f]=!0});
z(b,function(f){c[f]=!0});
var d="",e;for(e in c)d+=0<d.length?" "+e:e;hf(a,d)}}
function M(a,b){a.classList?a.classList.remove(b):K(a,b)&&hf(a,Pa(gf(a),function(c){return c!=b}).join(" "))}
function kf(a,b){a.classList?z(b,function(c){M(a,c)}):hf(a,Pa(gf(a),function(c){return!Ua(b,c)}).join(" "))}
function lf(a,b,c){c?L(a,b):M(a,b)}
function mf(a,b,c){K(a,b)&&(M(a,b),L(a,c))}
function nf(a,b){var c=!K(a,b);lf(a,b,c)}
;var of=!B&&!sb();function pf(a,b){if(/-[a-z]/.test(b))return null;if(of&&a.dataset){if(ub()&&!(b in a.dataset))return null;var c=a.dataset[b];return void 0===c?null:c}return a.getAttribute("data-"+String(b).replace(/([A-Z])/g,"-$1").toLowerCase())}
;var qf="StopIteration"in n?n.StopIteration:{message:"StopIteration",stack:""};function rf(){}
rf.prototype.next=function(){throw qf;};
rf.prototype.L=function(){return this};
function sf(a){if(a instanceof rf)return a;if("function"==typeof a.L)return a.L(!1);if(Ca(a)){var b=0,c=new rf;c.next=function(){for(;;){if(b>=a.length)throw qf;if(b in a)return a[b++];b++}};
return c}throw Error("Not implemented");}
function tf(a,b){if(Ca(a))try{z(a,b,void 0)}catch(c){if(c!==qf)throw c;}else{a=sf(a);try{for(;;)b.call(void 0,a.next(),void 0,a)}catch(c){if(c!==qf)throw c;}}}
function uf(a){if(Ca(a))return Xa(a);a=sf(a);var b=[];tf(a,function(c){b.push(c)});
return b}
;function vf(a,b){this.i={};this.f=[];this.M=this.g=0;var c=arguments.length;if(1<c){if(c%2)throw Error("Uneven number of arguments");for(var d=0;d<c;d+=2)this.set(arguments[d],arguments[d+1])}else if(a)if(a instanceof vf)for(c=wf(a),d=0;d<c.length;d++)this.set(c[d],a.get(c[d]));else for(d in a)this.set(d,a[d])}
function wf(a){xf(a);return a.f.concat()}
m=vf.prototype;m.equals=function(a,b){if(this===a)return!0;if(this.g!=a.g)return!1;var c=b||yf;xf(this);for(var d,e=0;d=this.f[e];e++)if(!c(this.get(d),a.get(d)))return!1;return!0};
function yf(a,b){return a===b}
m.isEmpty=function(){return 0==this.g};
m.clear=function(){this.i={};this.M=this.g=this.f.length=0};
m.remove=function(a){return Object.prototype.hasOwnProperty.call(this.i,a)?(delete this.i[a],this.g--,this.M++,this.f.length>2*this.g&&xf(this),!0):!1};
function xf(a){if(a.g!=a.f.length){for(var b=0,c=0;b<a.f.length;){var d=a.f[b];Object.prototype.hasOwnProperty.call(a.i,d)&&(a.f[c++]=d);b++}a.f.length=c}if(a.g!=a.f.length){var e={};for(c=b=0;b<a.f.length;)d=a.f[b],Object.prototype.hasOwnProperty.call(e,d)||(a.f[c++]=d,e[d]=1),b++;a.f.length=c}}
...
m.forEach=function(a,b){for(var c=wf(this),d=0;d<c.length;d++){var e=c[d],f=this.get(e);a.call(b,f,e,this)}};
m.clone=function(){return new vf(this)};
m.L=function(a){xf(this);var b=0,c=this.M,d=this,e=new rf;e.next=function(){if(c!=d.M)throw Error("The map has changed since the iterator was created");if(b>=d.f.length)throw qf;var f=d.f[b++];return a?f:d.i[f]};
return e};function zf(a){var b=[];Af(new Bf,a,b);return b.join("")}
function Bf(){}
function Af(a,b,c){if(null==b)c.push("null");else{if("object"==typeof b){if(Ba(b)){var d=b;b=d.length;c.push("[");for(var e="",f=0;f<b;f++)c.push(e),Af(a,d[f],c),e=",";c.push("]");return}if(b instanceof String||b instanceof Number||b instanceof Boolean)b=b.valueOf();else{c.push("{");e="";for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(f=b[d],"function"!=typeof f&&(c.push(e),Cf(d,c),c.push(":"),Af(a,f,c),e=","));c.push("}");return}}switch(typeof b){case "string":Cf(b,c);break;case "number":c.push(isFinite(b)&&
...
;var Ff=function(){if(ac){var a=/Windows NT ([0-9.]+)/;return(a=a.exec(fb))?a[1]:"0"}return $b?(a=/10[_.][0-9_.]+/,(a=a.exec(fb))?a[0].replace(/_/g,"."):"10"):bc?(a=/Android\s+([^\);]+)(\)|;)/,(a=a.exec(fb))?a[1]:""):cc||dc||ec?(a=/(?:iPhone|CPU)\s+OS\s+(\S+)/,(a=a.exec(fb))?a[1].replace(/_/g,"."):""):""}();function Gf(a){return(a=a.exec(fb))?a[1]:""}
var Hf=function(){if(pc)return Gf(/Firefox\/([0-9.]+)/);if(B||Wb||Vb)return mc;if(tc)return Rb()?Gf(/CriOS\/([0-9.]+)/):Gf(/Chrome\/([0-9.]+)/);if(uc&&!Rb())return Gf(/Version\/([0-9.]+)/);if(qc||rc){var a=/Version\/(\S+).*Mobile\/(\S+)/.exec(fb);if(a)return a[1]+"."+a[2]}else if(sc)return(a=Gf(/Android\s+([0-9.]+)/))?a:Gf(/Version\/([0-9.]+)/);return""}();function If(a,b,c,d,e,f,h){var g;if(g=c.offsetParent){var k="HTML"==g.tagName||"BODY"==g.tagName;if(!k||"static"!=Ad(g,"position")){var l=Ed(g);if(!k){k=Kd(g);var p;if(p=k){if(p=uc)p=0<=db(Hf,10);var q;if(q=fc)q=0<=db(Ff,10);p=Yb||p||q}k=p?-g.scrollLeft:!k||Xb&&nc("8")||"visible"==Ad(g,"overflowX")?g.scrollLeft:g.scrollWidth-g.clientWidth-g.scrollLeft;l=Bc(l,new D(k,g.scrollTop))}}}g=l||new D;l=Jd(a);if(k=Dd(a)){var t=new vd(k.left,k.top,k.right-k.left,k.bottom-k.top);k=Math.max(l.left,t.left);p=
...
u.y}a=Jf(a,b);b=l.left;a&4?b+=l.width:a&2&&(b+=l.width/2);b=new D(b,l.top+(a&1?l.height:0));b=Bc(b,g);e&&(b.x+=(a&4?-1:1)*e.x,b.y+=(a&1?-1:1)*e.y);var F;h&&(F=Dd(c))&&(F.top-=g.y,F.right-=g.x,F.bottom-=g.y,F.left-=g.x);return Kf(b,c,d,f,F,h,void 0)}
function Kf(a,b,c,d,e,f,h){a=a.clone();var g=Jf(b,c);c=Hd(b);h=h?h.clone():c.clone();a=a.clone();h=h.clone();var k=0;if(d||0!=g)g&4?a.x-=h.width+(d?d.right:0):g&2?a.x-=h.width/2:d&&(a.x+=d.left),g&1?a.y-=h.height+(d?d.bottom:0):d&&(a.y+=d.top);if(f){if(e){d=a;g=h;k=0;65==(f&65)&&(d.x<e.left||d.x>=e.right)&&(f&=-2);132==(f&132)&&(d.y<e.top||d.y>=e.bottom)&&(f&=-5);d.x<e.left&&f&1&&(d.x=e.left,k|=1);if(f&16){var l=d.x;d.x<e.left&&(d.x=e.left,k|=4);d.x+g.width>e.right&&(g.width=Math.min(e.right-d.x,
...
function Jf(a,b){return(b&8&&Kd(a)?b^4:b)&-9}
;function Lf(a){this.f=0;this.B=void 0;this.l=this.g=this.i=null;this.o=this.v=!1;if(a!=xa)try{var b=this;a.call(void 0,function(c){Mf(b,2,c)},function(c){Mf(b,3,c)})}catch(c){Mf(this,3,c)}}
...
var Of=new Ne(function(){return new Nf},function(a){a.reset()});
function Pf(a,b,c){var d=Of.get();d.g=a;d.onRejected=b;d.context=c;return d}
Lf.prototype.then=function(a,b,c){return Qf(this,Da(a)?a:null,Da(b)?b:null,c)};
Lf.prototype.$goog_Thenable=!0;Lf.prototype.cancel=function(a){if(0==this.f){var b=new Rf(a);Ve(function(){Sf(this,b)},this)}};
function Sf(a,b){if(0==a.f)if(a.i){var c=a.i;if(c.g){for(var d=0,e=null,f=null,h=c.g;h&&(h.i||(d++,h.f==a&&(e=h),!(e&&1<d)));h=h.next)e||(f=h);e&&(0==c.f&&1==d?Sf(c,b):(f?(d=f,d.next==c.l&&(c.l=d),d.next=d.next.next):Tf(c),Uf(c,e,3,b)))}a.i=null}else Mf(a,3,b)}
function Vf(a,b){a.g||2!=a.f&&3!=a.f||Wf(a);a.l?a.l.next=b:a.g=b;a.l=b}
function Qf(a,b,c,d){var e=Pf(null,null,null);e.f=new Lf(function(f,h){e.g=b?function(g){try{var k=b.call(d,g);f(k)}catch(l){h(l)}}:f;
e.onRejected=c?function(g){try{var k=c.call(d,g);void 0===k&&g instanceof Rf?h(g):f(k)}catch(l){h(l)}}:h});
e.f.i=a;Vf(a,e);return e.f}
Lf.prototype.K=function(a){this.f=0;Mf(this,2,a)};
Lf.prototype.V=function(a){this.f=0;Mf(this,3,a)};
function Mf(a,b,c){if(0==a.f){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.f=1;a:{var d=c,e=a.K,f=a.V;if(d instanceof Lf){Vf(d,Pf(e||xa,f||null,a));var h=!0}else{if(d)try{var g=!!d.$goog_Thenable}catch(l){g=!1}else g=!1;if(g)d.then(e,f,a),h=!0;else{if(Ea(d))try{var k=d.then;if(Da(k)){Xf(d,k,e,f,a);h=!0;break a}}catch(l){f.call(a,l);h=!0;break a}h=!1}}}h||(a.B=c,a.f=b,a.i=null,Wf(a),3!=b||c instanceof Rf||Yf(a,c))}}
function Xf(a,b,c,d,e){function f(k){g||(g=!0,d.call(e,k))}
function h(k){g||(g=!0,c.call(e,k))}
var g=!1;try{b.call(a,h,f)}catch(k){f(k)}}
function Wf(a){a.v||(a.v=!0,Ve(a.F,a))}
function Tf(a){var b=null;a.g&&(b=a.g,a.g=b.next,b.next=null);a.g||(a.l=null);return b}
Lf.prototype.F=function(){for(var a;a=Tf(this);)Uf(this,a,this.f,this.B);this.v=!1};
function Uf(a,b,c,d){if(3==c&&b.onRejected&&!b.i)for(;a&&a.o;a=a.i)a.o=!1;if(b.f)b.f.i=null,Zf(b,c,d);else try{b.i?b.g.call(b.context):Zf(b,c,d)}catch(e){$f.call(null,e)}Oe(Of,b)}
function Zf(a,b,c){2==b?a.g.call(a.context,c):a.onRejected&&a.onRejected.call(a.context,c)}
function Yf(a,b){a.o=!0;Ve(function(){a.o&&$f.call(null,b)})}
var $f=Pe;function Rf(a){Ma.call(this,a)}
y(Rf,Ma);Rf.prototype.name="cancel";function N(a){df.call(this);this.B=1;this.o=[];this.v=0;this.f=[];this.g={};this.F=!!a}
y(N,df);m=N.prototype;m.subscribe=function(a,b,c){var d=this.g[a];d||(d=this.g[a]=[]);var e=this.B;this.f[e]=a;this.f[e+1]=b;this.f[e+2]=c;this.B=e+3;d.push(e);return e};
...
function cg(a,b,c){Ve(function(){a.apply(b,c)})}
...
eg.prototype.set=function(a,b){void 0===b?this.f.remove(a):this.f.set(a,zf(b))};
...
;function kg(){}
y(kg,jg);kg.prototype.clear=function(){var a=uf(this.L(!0)),b=this;z(a,function(c){b.remove(c)})};function lg(a){this.f=a}
...
m.L=function(a){var b=0,c=this.f,d=new rf;d.next=function(){if(b>=c.length)throw qf;var e=c.key(b++);if(a)return e;e=c.getItem(e);if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
return d};
...
y(mg,lg);function ng(a,b){this.g=a;this.f=null;if(B&&!(9<=Number(oc))){og||(og=new vf);this.f=og.get(a);this.f||(b?this.f=document.getElementById(b):(this.f=document.createElement("userdata"),this.f.addBehavior("#default#userData"),document.body.appendChild(this.f)),og.set(a,this.f));try{this.f.load(this.g)}catch(c){this.f=null}}}
...
m.L=function(a){var b=0,c=this.f.XMLDocument.documentElement.attributes,d=new rf;d.next=function(){if(b>=c.length)throw qf;var e=c[b++];if(a)return decodeURIComponent(e.nodeName.replace(/\./g,"%")).substr(1);e=e.nodeValue;if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
return d};
...
sg.prototype.L=function(a){var b=this.g.L(!0),c=this,d=new rf;d.next=function(){for(var e=b.next();e.substr(0,c.f.length)!=c.f;)e=b.next();return a?e.substr(c.f.length):c.g.get(e)};
...
return b}
function gh(){lf(document.body,"hide-players",!1);z(Gc("preserve-players"),function(a){M(a,"preserve-players")})}
...
ih.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var lb=v("ytEventsEventsListeners")||{};x("ytEventsEventsListeners",lb);var jh=v("ytEventsEventsCounter")||{count:0};x("ytEventsEventsCounter",jh);
function kh(a,b,c,d){d=void 0===d?{}:d;a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return kb(function(e){var f="boolean"===typeof e[4]&&e[4]==!!d,h=Ea(e[4])&&Ea(d)&&nb(e[4],d);return!!e.length&&e[0]==a&&e[1]==b&&e[2]==c&&(f||h)})}
...
h=yg(h);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),lh()||"boolean"===typeof d?a.addEventListener(b,h,d):a.addEventListener(b,h,!!d.capture)):a.attachEvent("on"+b,h);lb[e]=[a,b,c,h,d];return e}
...
var lh=bb(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
...
function W(a){a&&("string"==typeof a&&(a=[a]),z(a,function(b){if(b in lb){var c=lb[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?lh()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete lb[b]}}))}
...
;var yh=window.yt&&window.yt.uix&&window.yt.uix.widgets_||{};x("yt.uix.widgets_",yh);function zh(a){var b=[];ib(a,function(c,d){var e=encodeURIComponent(String(d)),f;Ba(c)?f=c:f=[c];z(f,function(h){""==h?b.push(e):b.push(e+"="+encodeURIComponent(String(h)))})});
return b.join("&")}
...
;function Dh(a){a=void 0===a?{}:a;Da(a)&&(a={callback:a});if(a.gapiHintOverride||O("GAPI_HINT_OVERRIDE")){var b=document.location.href;-1!=b.indexOf("?")?(b=(b||"").split("#")[0],b=b.split("?",2),b=Ah(1<b.length?b[1]:b[0])):b={};(b=b.gapi_jsh)&&qb(a,{_c:{jsl:{h:b}}})}Je("gapi.iframes:gapi.iframes.style.common",a)}
...
;function ci(a,b){(a=E(a))&&a.style&&(a.style.display=b?"":"none",lf(a,"hid",!b))}
...
function hi(a,b){if(b){var c=ii(a,b);if(c){var d=E(ji(a,b));if(!d){d=document.createElement("div");d.id=ji(a,b);hf(d,X(a,"tip"));var e=document.createElement("div");hf(e,X(a,"tip-body"));var f=document.createElement("div");hf(f,X(a,"tip-arrow"));var h=document.createElement("div");h.setAttribute("aria-hidden","true");hf(h,X(a,"tip-content"));var g=mi(a,b),k=ji(a,b,"content");h.id=k;Kg(b,"content-id",k);e.appendChild(h);g&&d.appendChild(g);d.appendChild(e);d.appendChild(f);var l=cd(b);k=ji(a,b,"arialabel");
...
function ni(a,b,c,d,e,f){lf(c,X(a,"tip-reverse"),f);var h=0;f&&(h=1);var g=Hd(b);f=new D((g.width-10)/2,f?g.height:0);var k=Ed(b);Kf(new D(k.x+f.x,k.y+f.y),c,h);f=Kc(window);if(1==c.nodeType)var l=Fd(c);else c=c.changedTouches?c.changedTouches[0]:c,l=new D(c.clientX,c.clientY);c=Hd(d);var p=Math.floor(c.width/2);h=!!(f.height<l.y+g.height);g=!!(l.y<g.height);k=!!(l.x<p);f=!!(f.width<l.x+p);l=(c.width+3)/-2- -5;a=a.j(b,"force-tooltip-direction");if("left"==a||k)l=-5;else if("right"==a||f)l=20-c.width-
...
function mi(a,b){var c=null;ac&&K(b,X(a,"masked"))&&((c=E("yt-uix-tooltip-shared-mask"))?(c.parentNode.removeChild(c),ei(c)):(c=Pc(document,"IFRAME"),c.src='javascript:""',c.id="yt-uix-tooltip-shared-mask",hf(c,X(a,"tip-mask"))));return c}
...
var Ji=v("ytLoggingTransportDispatchedStats_")||{};x("ytLoggingTransportDispatchedStats_",Ji);x("ytytLoggingTransportCapturedTime_",v("ytLoggingTransportCapturedTime_")||{});function Ki(){Bg(Di);Bg(Ei);Ei=0;if(!mb(Hi)){for(var a in Hi){var b=Ci[a];b&&b.isReady()&&(Li(a,b),delete Hi[a],Gi=!1)}mb(Hi)||Mi()}}
...
function Li(a,b){var c=zi[a],d=Ji[a]||{};Ji[a]=d;var e=Math.round(ui());for(q in Hi[a]){var f=ob,h=b.f||Oi();h={client:{hl:h.hb,gl:h.gb,clientName:h.fb,clientVersion:h.innertubeContextClientVersion,configInfo:h.eb}};var g=window.devicePixelRatio;g&&1!=g&&(h.client.screenDensityFloat=String(g));g=O("EXPERIMENTS_TOKEN","");""!==g&&(h.client.experimentsToken=g);var k=g=void 0,l=[],p=O("EXPERIMENTS_FORCED_FLAGS",{});for(k in p)l.push({key:k,value:String(p[k])});k=O("EXPERIMENT_FLAGS",{});for(g in k)g.startsWith("force_")&&
...
function Vi(a){var b=a.f;try{var c=b.screenX;var d=b.screenY}catch(l){}try{var e=b.outerWidth;var f=b.outerHeight}catch(l){}try{var h=b.innerWidth;var g=b.innerHeight}catch(l){}b=[b.screenLeft,b.screenTop,c,d,b.screen?b.screen.availWidth:void 0,b.screen?b.screen.availTop:void 0,e,f,h,g];c=a.f.top;try{var k=Kc(c||window).round()}catch(l){k=new Cc(-12245933,-12245933)}c=k;k={};d=new Le;n.SVGElement&&n.document.createElementNS&&d.set(0);e=td();e["allow-top-navigation-by-user-activation"]&&d.set(1);e["allow-popups-to-escape-sandbox"]&&
d.set(2);n.crypto&&n.crypto.subtle&&d.set(3);n.TextDecoder&&n.TextEncoder&&d.set(4);d=Me(d);k.bc=d;k.bih=c.height;k.biw=c.width;k.brdim=b.join();a=a.g;return k.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[a.visibilityState||a.webkitVisibilityState||a.mozVisibilityState||""]||0,k.wgl=!!C.WebGLRenderingContext,k}
...
pj.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,La()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(zf(b))}catch(f){return}else e=escape(b);b=this.g;yc.set(""+a,e,{sa:c,path:"/",domain:void 0===b?"youtube.com":b,secure:!1})};
...
function tj(a){var b=qj.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(ui())-d.requestTime)){var e=d.authState,f=oj(nj(!1));nb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(ui())),Pi(a,d.method,e,{}));delete b[c]}}qj.set("requests",b,86400,!0)}}
...
function Zj(a,b){var c=b.iframeMask;c||(c=Pc(document,"IFRAME"),c.src='javascript:""',hf(c,X(a,"menu-mask")),fi(c),b.iframeMask=c);return c}
...
2));d&&(k.y+=Mc(document).y);if(a=Zj(a,b))b=Hd(c),a.style.width=b.width+"px",a.style.height=b.height+"px",If(e,f,a,h,k,l,197),d&&wd(a,"position","fixed");If(e,f,c,h,k,l,197)}
...
var f=[X(a,"active")];e&&f.push(X(a,"group-active"));kf(b,f);R("yt-uix-button-menu-hide",b);W(a.i);a.i.length=0}}
...
L(c.parentNode,d)}
function Sj(a,b){if(!b.widgetMenu){var c=a.j(b,"button-menu-id");c=c&&E(c);var d=X(a,"menu");c?jf(c,[d,X(a,"menu-external")]):c=G(d,b);b.widgetMenu=c}return b.widgetMenu}
m.isToggled=function(a){return K(a,X(this,"toggled"))};
m.toggle=function(a){if(this.j(a,"button-toggle")){var b=H(a,X(this,"group")),c=X(this,"toggled"),d=K(a,c);if(b&&this.j(b,"button-toggle-group")){var e=this.j(b,"button-toggle-group");z(Gc(X(this),b),function(f){f!=a||"optional"==e&&d?(M(f,c),f.removeAttribute("aria-pressed")):(L(a,c),f.setAttribute("aria-pressed","true"))})}else d?a.removeAttribute("aria-pressed"):a.setAttribute("aria-pressed","true"),nf(a,c)}};
...
function ek(a,b,c){var d=c||b,e=X(a,"card");c=hk(a,d);var f=E(X(a,"card")+bh(d));if(f)return a=G(X(a,"card-body"),f),Tc(a,c)||(Qc(c),a.appendChild(c)),f;f=document.createElement("div");f.id=X(a,"card")+bh(d);hf(f,e);(d=a.j(d,"card-class"))&&jf(f,d.split(/\s+/));d=document.createElement("div");d.className=X(a,"card-border");b=a.j(b,"orientation")||"horizontal";e=document.createElement("div");e.className="yt-uix-card-border-arrow yt-uix-card-border-arrow-"+b;var h=document.createElement("div");h.className=
...
Math.min(f,(d?u.height:u.width)-24-6);6>f&&(f=6,d?r.y+=12-b.offsetHeight/2:r.x+=12-b.offsetWidth/2);u=null;h||(u=10);b=X(a,"card-flip");a=X(a,"card-reverse");lf(c,b,l);lf(c,a,k);u=If(e,p,c,q,r,null,u);!h&&u&&(u&48&&(l=!l,p^=4,q^=4),u&192&&(k=!k,p^=1,q^=1),lf(c,b,l),lf(c,a,k),If(e,p,c,q,r));g&&(e=parseInt(c.style.top,10),h=Mc(document).y,wd(c,"position","fixed"),wd(c,"top",e-h+"px"));t&&(c.style.right="",e=Jd(c),e.left=e.left||parseInt(c.style.left,10),h=Kc(window),c.style.left="",c.style.right=h.width-
...
function gk(a){var b=a.cardMask;b||(b=Pc(document,"IFRAME"),b.src='javascript:""',jf(b,["yt-uix-card-iframe-mask"]),a.cardMask=b);b.style.position=a.style.position;b.style.top=a.style.top;b.style.left=a.offsetLeft+"px";b.style.height=a.clientHeight+"px";b.style.width=a.clientWidth+"px";document.body.appendChild(b)}
...
function mk(a,b,c){if(b&&c)if(L(c,X(a)),a=b.id,a||(a="kbd-nav-"+Math.floor(1E6*Math.random()+1),b.id=a),b=a,of&&c.dataset)c.dataset.kbdNavMoveOut=b;else{if(/-[a-z]/.test("kbdNavMoveOut"))throw Error("");c.setAttribute("data-"+"kbdNavMoveOut".replace(/([A-Z])/g,"-$1").toLowerCase(),b)}}
...
this.l=new N};
m.unregister=function(){Z(this,"click",this.na);this.g=this.f=null;W(ab(jb(this.i)));this.i={};ib(this.v,function(a){Qc(a)},this);
this.v={};ef(this.l);this.l=null;nk.A.unregister.call(this)};
...
function sk(a,b,c){var d=tk(a,b);if(d){var e=Hd(c);if(e instanceof Cc){var f=e.height;e=e.width}else throw Error("missing height argument");d.style.width=Gd(e,!0);d.style.height=Gd(f,!0)}c==a.f&&(e=9,f=8,K(b,X(a,"reversed"))&&(e^=1,f^=1),K(b,X(a,"flipped"))&&(e^=4,f^=4),a=new D(0,1),d&&If(b,e,d,f,a,null,197),If(b,e,c,f,a,null,197))}
function rk(a,b,c){uk(a,b)&&!c?pk(a,b):(vk(a,b),!a.f||dh(b,a.f)?a.Na(b):ag(a.l,w(a.Na,a,b)))}
m.Na=function(a){if(a){var b=wk(this,a);if(b){Jg("yt-uix-menu-before-show",a,b);this.f?dh(a,this.f)||pk(this,this.g):(this.g=a,this.f=b,K(a,X(this,"sibling-content"))||(Qc(b),document.body.appendChild(b)),b.style.minWidth=qk(this,a).offsetWidth-2+"px");var c=tk(this,a);c&&b.parentNode&&b.parentNode.insertBefore(c,b.nextSibling);M(b,X(this,"content-hidden"));sk(this,a,b);jf(qk(this,a),[X(this,"trigger-selected"),"yt-uix-button-toggled"]);R("yt-uix-menu-show",a);xk(b);yk(this,a);R("yt-uix-kbd-nav-move-in-to",
...
function Ak(a,b){if(b){var c=wk(a,b);kf(qk(a,b),[X(a,"trigger-selected"),"yt-uix-button-toggled"]);L(c,X(a,"content-hidden"));var d=wk(a,b);d&&Ic(d,{"aria-expanded":"false"});(d=tk(a,b))&&d.parentNode&&Qc(d);c&&c==a.f&&(a.g.appendChild(c),a.f=null,a.g=null,a.l&&a.l.J("ROOT_MENU_REMOVED"));R("yt-uix-menu-hide",b);c=Fa(b).toString();W(a.i[c]);delete a.i[c]}}
...
function Bk(a,b,c){var d=wk(a,b);d&&K(b,X(a,"checked"))&&(a=ed(c,"LI"))&&(a=G("yt-ui-menu-item-checked-hid",a))&&(z(Gc("yt-ui-menu-item-checked",d),function(e){mf(e,"yt-ui-menu-item-checked","yt-ui-menu-item-checked-hid")}),mf(a,"yt-ui-menu-item-checked-hid","yt-ui-menu-item-checked"))}
function uk(a,b){var c=wk(a,b);return c?!K(c,X(a,"content-hidden")):!1}
function xk(a){z(Hc(document,"UL",null,a),function(b){b.tabIndex=0;var c=ik.w();jf(b,[X(c),X(c,"list")])})}
function wk(a,b){var c=Mg(b,"menu-content-id");return c&&(c=E(c))?(jf(c,[X(a,"content"),X(a,"content-external")]),c):b==a.g?a.f:G(X(a,"content"),b)}
function tk(a,b){var c=Fa(b).toString(),d=a.v[c];if(!d){d=Pc(document,"IFRAME");d.src='javascript:""';var e=[X(a,"mask")];z(gf(b),function(f){e.push(f+"-mask")});
jf(d,e);a.v[c]=d}return d||null}
...
function Gk(a){a=G("yt-dialog-fg-content",a.f);var b=[];ib(Hk,function(c){b.push("yt-dialog-show-"+c)});
kf(a,b);L(a,"yt-dialog-show-content")}
m=Fk.prototype;
m.show=function(){if(!this.X()){this.B=document.activeElement;if(!this.Qa){this.g||(this.g=E("yt-dialog-bg"),this.g||(this.g=Pc(document,"div"),this.g.id="yt-dialog-bg",hf(this.g,"yt-dialog-bg"),document.body.appendChild(this.g)));var a=window,b=a.document;var c=0;if(b){c=b.body;var d=b.documentElement;if(d&&c)if(a=Kc(a).height,Lc(b)&&d.scrollHeight)c=d.scrollHeight!=a?d.scrollHeight:d.offsetHeight;else{b=d.scrollHeight;var e=d.offsetHeight;d.clientHeight!=e&&(b=c.scrollHeight,e=c.offsetHeight);c=
...
m.pa=function(){if(!this.Sa){var a=this.f;lf(document.body,"hide-players",!0);a&&lf(a,"preserve-players",!0)}};
...
m.da=function(a){if(!this.f||!di(this.f.f)){var b=this.D(a);a=Qk(b,a);b||(b=a?a.overlayParentNode:null);if(b&&a){var c=!!this.j(b,"disable-shortcuts")||!1,d=!!this.j(b,"disable-outside-click-dismiss")||!1;this.f=new Fk(a,c);this.i=b;var e=G("yt-dialog-fg",a);if(e){var f=this.j(b,"overlay-class")||"",h=this.j(b,"overlay-style")||"default",g=this.j(b,"overlay-shape")||"default";f=f?f.split(" "):[];f.push(X(this,h));f.push(X(this,g));jf(e,f)}this.f.show();R("yt-uix-kbd-nav-move-to",e||a);Pk(this);c||
...
function Xk(a,b){W(Vk);Vk.length=0;Uk[b]||(Uk[b]=Wk(a));Ok.w().show(Uk[b]);var c=Tk();return new Lf(function(d){Vk.push(oh(c,function(){d()},"overlay-confirmation-unsubscribe-button"))})}
...
m.Ga=function(a,b){var c=H(a,"yt-uix-button-subscription-container");lf(c,"yt-subscription-button-disabled-mask-container",b);a.setAttribute("aria-busy",b?"true":"false");a.disabled=b};
function bl(a,b){var c=a.j(b,"style-type"),d=!!a.j(b,"is-subscribed");c="-"+c;var e="yt-uix-button-subscribed"+c;lf(b,"yt-uix-button-subscribe"+c,!d);lf(b,e,d);a.j(b,"subscriber-count-tooltip")&&!a.j(b,"subscriber-count-show-when-subscribed")&&(c=X(gi.w()),lf(b,c,!d),b.title=d?"":a.j(b,"subscriber-count-title"));d?P(function(){L(b,"hover-enabled")},1E3):M(b,"hover-enabled")}
...
function Gl(a){var b=a.f;ib(a.g,function(c,d){U(Qh,new Jh(d,c,b[d]))})}
